...
| loadingPromise     | `Object`  | undefined   | Promise object for table data loading, on which then method function to remove loading state will be attached | 
